...
def generate_cases() -> list[dict]:
    ...
    cases.extend(with_implementations(linear_cases("fast"), implementations))
    cases.extend(with_implementations(clustering_cases("fast"), implementations))
    return cases
