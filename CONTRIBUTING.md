...
Automatically benchmarking an upstream scikit-learn PR against `main` from a
PR description on this repo is documented separately, in
[COMPARISONS_PR.md](COMPARISONS_PR.md).
